...
class Game:
    ...
    def menu_screen(self):
        ...
        menu.add.text_input('AI model: ', default=self.p2_name, maxchar=10, onchange=self.set_ai)
    ...
    def determine_move(self):
        ...
        if self.p2_name != "random":
            self.ai_move.put(AI.minimax(self.board.copy(),390, inf, -inf, True, self.p2_color)[0])
        else:
